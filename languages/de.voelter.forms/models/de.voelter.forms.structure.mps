...
<model ref="r:23c80d5c-ce08-4524-8f3c-b2b1fdbe09d4(de.voelter.forms.structure)">
  ...
  <node concept="1TIwiD" id="6W$F1JwhyyB">
    ...
    <node concept="1QGGSu" id="2ISIOq3F4Lp" role="rwd14">
      <property role="1iqoE4" value="${module}/icons/test.png" />
    </node>
  </node>
